// ====== Standaardboeken toevoegen als ze nog niet bestaan ======
...
if (path.includes('index.html') || path.endsWith('/')) {
    ...
    function updateBookOfTheMonth() {
        ...
        if (topBook) {
            ...
            // Emoji tonen als grote emoji
            if (bookDiv.querySelector('img')) {
                bookDiv.querySelector('img').style.display = 'none';
            }
            if (!bookDiv.querySelector('.emoji')) {
                ...
                bookDiv.querySelector('.emoji').textContent = book.emoji;
            }
        } else {
            bookDiv.querySelector('.stats').innerHTML = "No writing this month";
            if (bookDiv.querySelector('.emoji')) {
                bookDiv.querySelector('.emoji').textContent = '';
            }
        }
    }
